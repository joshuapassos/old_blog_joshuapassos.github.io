...
var _user$project$Model$model = {titulo: 'Index', data: '', url: '', conteudo: 'Carregando'};
var _user$project$Model$Model = F4(
	function (a, b, c, d) {
		return {conteudo: a, titulo: b, data: c, url: d};
	});

var _user$project$View$cafelove = {
	ctor: '::',
										...
										_1: {
											...
											_1: {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$href('https://github.com/joshuapassos'),
														_1: {
															ctor: '::',
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('Joshua Passos'),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
...
var _user$project$View$hfooter = A2(
...
var _user$project$View$hleftmenu = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('well well-lg col-md-2'),
		_1: {
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$align('center'),
			_1: {ctor: '[]'}
	...
	},
	{
		...
		_0: A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Categorias'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}),
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('nav nav-pills nav-stacked'),
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$html$Html_Attributes$attribute, 'style', 'max-width: 300px;'),
						_1: {ctor: '[]'}
					}
				},
				{
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$href('https://github.com'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
...
var _user$project$View$hinfo = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('alert alert-dismissible alert-info'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			_elm_lang$html$Html$button,
			{
				...
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$html$Html_Attributes$attribute, 'data-dismiss', 'alert'),
					_1: {
						ctor: '::',
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Esse artigo foi escrito: {{datap}}'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
var _user$project$View$hpost = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('container-fluid col-md-12'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$id('post'),
				_1: {ctor: '[]'}
			}
		},
		{
...
var _user$project$View$hpage = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: _user$project$View$hpost(model),
			_1: {ctor: '[]'}
		});
};
...
var _user$project$View$hbody = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$View$hnav,
			_1: {
				ctor: '::',
				_0: _user$project$View$hpage(model),
				_1: {
					ctor: '::',
					_0: _user$project$View$hfooter,
					_1: {ctor: '[]'}
				}
			}
		});
...
var _user$project$View$view = function (model) {
	return A3(
		...
		{
			ctor: '::',
			_0: _user$project$View$hbody(model),
			_1: {ctor: '[]'}
		});
};

var _user$project$Routes$verif = function (url) {
	var _p0 = url;
	switch (_p0) {
		case '':
			return 'sobre.md';
...
var _user$project$Main$getPost = function (url) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Main$NewPost,
	...
	function (msg, model) {
		...
		if (_p0.ctor === 'UrlChange') {
			return {
				ctor: '_Tuple2',
				_0: model,
				_1: _user$project$Main$getPost(
					_user$project$Routes$verif(_p0._0.hash))
			};
		} else {
			if (_p0._0.ctor === 'Ok') {
				return {
					ctor: '_Tuple2',
					_0: {titulo: model.titulo, data: model.data, url: model.url, conteudo: _p0._0._0},
...
var _user$project$Main$init = function (location) {
	return {
		...
		_0: {
			titulo: 'Index',
			data: location.hash,
			url: _elm_lang$core$Basics$toString(location),
			conteudo: 'Carregando'
		},
		_1: _user$project$Main$getPost(
			_user$project$Routes$verif(location.hash))
	};
};
